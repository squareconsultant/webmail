...
$(document).ready(function() {
	...
	(function () {
		...
		Mousetrap.bind('command+s', function(e) {
               ...
               if($('[data-space="code-editor-canvas"].active').length > 0){
                    ...
                    $('#save-template-button-wrapper').trigger('click');
          ...
          Mousetrap.bind('command+z', function(e) {
               ...
               if($('#template-editing-canvas :focus').length){  }

               else {

                    e.preventDefault();
                    retrieveMemoryKey('decrement');
                    checkEmptyCanvas();
                    setSaveActive();
                    return false;
          ...
          Mousetrap.bind('right', function(e) {
               ...
               if($('#crop-window').is(':visible')  && $(':focus').length < 1){

                    nudgeCropwWindow('right');
...
Mousetrap.bind('command+f', function(e) {
               ...
               if($('[data-space="code-editor-canvas"]').is(':visible')){

                    $('#find-replace-toggle-button').trigger('click');
